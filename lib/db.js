...
var BWSModule = require('bitcore-wallet-service').BitcoreNodeModule;
var InsightModule = require('insight').BitcoreNodeModule;
...
function DB(options) {
  ...
  this._modules = options.modules || this.getDefaultModules();
...
DB.prototype.getDefaultModules = function() {
  return [AddressModule, InsightModule, BWSModule];
};
