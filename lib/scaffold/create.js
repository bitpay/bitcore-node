...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'bitcore-lib': 'git://github.com/navcoindev/bitcore-lib.git',
    'bitcore-node': 'git://github.com/navcoindev/bitcore-node.git'
  }
};
...
function create(options, done) {
  ...
  async.series([
    ...
    function(next) {
      ...
      if (!isGlobal) {
        var npm = spawn('npm', ['install', '--unsafe-perm'], {cwd: absConfigDir});
