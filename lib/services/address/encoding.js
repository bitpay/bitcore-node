...
exports.encodeBalanceKey = function(hashBuffer, hashTypeBuffer) {
  return Buffer.concat([
    constants.PREFIXES.BALANCE,
    hashBuffer,
    hashTypeBuffer
  ]);
};
...
exports.encodeOutputKey = function(hashBuffer, hashTypeBuffer, height, txidBuffer) {
